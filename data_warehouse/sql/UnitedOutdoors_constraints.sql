...
FOREIGN KEY (PRODUCT_PRODUCT_SizeUnitMeasureCode)
REFERENCES UnitMeasure(UNITMEASURE_sk)
GO

ALTER TABLE Product
ADD CONSTRAINT FK_Product_UnitMeasure_Weight
FOREIGN KEY (PRODUCT_PRODUCT_WeightUnitMeasureCode)
REFERENCES UnitMeasure(UNITMEASURE_sk)
GO

ALTER TABLE BillOfMaterial
ADD CONSTRAINT FK_BillOfMaterial_UnitMeasure
FOREIGN KEY (BILLOFMATERIAL_BILLOFMATERIAL_UnitMeasureCode)
REFERENCES UnitMeasure(UNITMEASURE_sk)
GO
