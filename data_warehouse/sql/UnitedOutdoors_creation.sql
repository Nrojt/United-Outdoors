...
CREATE TABLE Illustration(
    ILLUSTRATION_sk INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
    ILLUSTRATION_ILLUSTRATION_IllustrationID INT,
    ILLUSTRATION_ILLUSTRATION_Diagram XML,
    ILLUSTRATION_PRODUCTMODELILLUSTRATION_ProductModelID INT,
    ILLUSTRATION_datetime_added DATETIME DEFAULT GETUTCDATE()
);
GO CREATE TABLE ProductPhoto(
    PRODUCTPHOTO_sk INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
    PRODUCTPHOTO_PRODUCTPHOTO_ProductPhotoID INT,
    PRODUCTPHOTO_PRODUCTPHOTO_ThumbNailPhoto VARBINARY(MAX),
    PRODUCTPHOTO_PRODUCTPHOTO_ThumbNailPhotoFileName NVARCHAR(50),
    PRODUCTPHOTO_PRODUCTPHOTO_LargePhoto VARBINARY(MAX),
    PRODUCTPHOTO_PRODUCTPHOTO_LargePhotoFileName NVARCHAR(50),
    PRODUCTPHOTO_PRODUCTPRODUCTPHOTO_ProductID INT,
    PRODUCTPHOTO_PRODUCTPRODUCTPHOTO_Primary INT,
    PRODUCTPHOTO_datetime_added DATETIME DEFAULT GETUTCDATE()
);
GO*/
