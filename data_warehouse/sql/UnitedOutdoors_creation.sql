...
CREATE TABLE CreditCard(
    ...
    CREDITCARD_CREDITCARD_CardNumber NVARCHAR(100),
    CREDITCARD_CREDITCARD_ExpMonth NVARCHAR(20),
    CREDITCARD_CREDITCARD_ExpYear INT(4),
...
CREATE TABLE Currency(
    ...
    CURRENCY_CURRENCY_CurrencyCode INT,
    CURRENCY_CURRENCY_Name NVARCHAR(100),
    CURRENCY_COUNTRYREGIONCURRENCY_CountryRegionCode INT,
    CURRENCY_CURRENCYRATE_CurrencyRateID INT,
    CURRENCY_CURRENCYRATE_CurrencyRateDate DATE,
    CURRENCY_CURRENCYRATE_FromCurrencyCode INT,
    CURRENCY_CURRENCYRATE_ToCurrencyCode INT,
...
CREATE TABLE Territory(
    ...
    TERRITORY_STATE_Color NVARCHAR(50),
    TERRITORY_COUNTRYREGION_CountryRegionCode INT,
    TERRITORY_COUNTRYREGION_Name NVARCHAR(100),
    TERRITORY_STATEPROVINCE_StateProvinceID INT,
    TERRITORY_STATEPROVINCE_StateProvinceCode INT, -- ?
    TERRITORY_STATEPROVINCE_IsOnlyStateProvinceFlag CHAR(1),
    TERRITORY_STATEPROVINCE_Name NVARCHAR(100),
    TERRITORY_STATEPROVINCE_TerritoryID INT,
    TERRITORY_SALESTAXRATE_SalesTaxRateID INT,
    TERRITORY_SALESTAXRATE_TaxType NVHARCHAR(50),
    TERRITORY_SALESTAXRATE_TaxRate INT,
    TERRITORY_SALESTAXRATE_Name NVARCHAR(50),
