...
CREATE TABLE Location (
    LOCATION_sk INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
    LOCATION_LOCATION_LocationID INT,
    LOCATION_LOCATION_Name NVARCHAR(50),
    LOCATION_LOCATION_CostRate MONEY,
    LOCATION_LOCATION_Availability DECIMAL(8,2),
    LOCATION_datetime_added DATETIME DEFAULT GETUTCDATE()
);
GO
...
CREATE TABLE SalesOrderHeader(
    ...
    SALESORDERHEADER_ORDERS_CustomerID CHAR(5),
    ...
    SALESORDERHEADER_ORDERS_Freight MONEY,
    ...
    SALESORDERHEADER_ORDERDETAILS_ProductID INT,
    SALESORDERHEADER_ORDERDETAILS_UnitPrice MONEY,
    SALESORDERHEADER_ORDERDETAILS_Quantity INT,
    SALESORDERHEADER_ORDERDETAILS_Discount REAL,
    SALESORDERHEADER_SHIPPERS_ShipperID INT,
    ...
    SALESORDERHEADER_SALESORDER_CustID INT,
    SALESORDERHEADER_SALESORDER_OrderDate DATE,
    ...
    SALESORDERHEADER_SALESORDERITEM_ProdID INT,
    SALESORDERHEADER_SALESORDERITEM_Quantity INT,
    SALESORDERHEADER_SALESORDERITEM_ShipDate DATE,
